...
public class FeelShareApplication extends MultiDexApplication {
    ...
    private static final String TAG = "FeelShareApplication";
    ...
    private HashMap<String, LatLng> allCountryLatLng;
    ...
    public void onCreate() {
        ...
        moodsNames = new String[]{
                mContext.getResources().getString(R.string.afraid),
                mContext.getResources().getString(R.string.angry),
                mContext.getResources().getString(R.string.bore),
                mContext.getResources().getString(R.string.naughty),
                mContext.getResources().getString(R.string.confused),
                mContext.getResources().getString(R.string.cool),
                mContext.getResources().getString(R.string.crying),
                mContext.getResources().getString(R.string.depression),
                mContext.getResources().getString(R.string.excited),
                mContext.getResources().getString(R.string.frustated),
                mContext.getResources().getString(R.string.funny),
                mContext.getResources().getString(R.string.happy),
                mContext.getResources().getString(R.string.hungry),
                mContext.getResources().getString(R.string.neutral),
                mContext.getResources().getString(R.string.romantic),
                mContext.getResources().getString(R.string.sad),
                mContext.getResources().getString(R.string.scared),
                mContext.getResources().getString(R.string.shy),
                mContext.getResources().getString(R.string.sick),
                mContext.getResources().getString(R.string.sleepy),
                mContext.getResources().getString(R.string.surprised),
                mContext.getResources().getString(R.string.tired)
        };
        ...
        moodsDesc = new String[]{
                mContext.getResources().getString(R.string.afraid_desc),
                mContext.getResources().getString(R.string.angry_desc),
                mContext.getResources().getString(R.string.bore_desc),
                mContext.getResources().getString(R.string.naughty_desc),
                mContext.getResources().getString(R.string.confused_desc),
                mContext.getResources().getString(R.string.cool_desc),
                mContext.getResources().getString(R.string.crying_desc),
                mContext.getResources().getString(R.string.depression_desc),
                mContext.getResources().getString(R.string.excited_desc),
                mContext.getResources().getString(R.string.frustated_desc),
                mContext.getResources().getString(R.string.funny_desc),
                mContext.getResources().getString(R.string.happy_desc),
                mContext.getResources().getString(R.string.hungry_desc),
                mContext.getResources().getString(R.string.neutral_desc),
                mContext.getResources().getString(R.string.romantic_desc),
                mContext.getResources().getString(R.string.sad_desc),
                mContext.getResources().getString(R.string.scared_desc),
                mContext.getResources().getString(R.string.shy_desc),
                mContext.getResources().getString(R.string.sick_desc),
                mContext.getResources().getString(R.string.sleepy_desc),
                mContext.getResources().getString(R.string.surprised_desc),
                mContext.getResources().getString(R.string.tired_desc)
        };

        allCountryLatLng = new HashMap<String, LatLng>() {{
    ...
    public LatLng getCountryLatLng(String countryAlpha2Code){
        return allCountryLatLng.get(countryAlpha2Code);
    }

    public HashMap<String, LatLng> getAllCountryLatLng(){
        return allCountryLatLng;
    }
    ...
    public String getDeviceCountry() {
        ...
        try {
            ...
            // simcard maker country code (service provider encode information on simcard)
            countryDetected = telephonyManager.getSimCountryIso();
            if (countryDetected != null && countryDetected.length() == 2) {
                deviceCountry = countryDetected.toUpperCase(Locale.ENGLISH);
            }

            // if unable to get simcard maker country (manufacturer do not provide information)
            // get network location country using sim card information
            // user must have a sim card and connected to a 2g/3g/4g network (exclude Code Division Multiple Access phone types)
            if (deviceCountry == null) {
                if (telephonyManager.getPhoneType() != TelephonyManager.PHONE_TYPE_CDMA) {
                    countryDetected = telephonyManager.getNetworkCountryIso();
                    if (countryDetected != null && countryDetected.length() == 2) {
                        deviceCountry = countryDetected.toUpperCase(Locale.ENGLISH);
                    }
                }
        ...
        // Unable to get accurate country code using sim card information
        // default to  user locale country
        if (deviceCountry == null) {
            deviceCountry = mContext.getResources().getConfiguration().locale.getCountry();
        }
